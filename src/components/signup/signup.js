  ...
  return (
     ...
     <div className="flex-row "   >
          <div className='flex justify-start mt-28'  >
               <h1><b>WELCOME TO EXPENSE INCOME TRACKER</b></h1>
          ...
          <div>
              ...
              <Input type="email"  name='email' label="Email" onChange={formik.handleChange} value={formik.values.email}></Input>
          </div>
          <br></br>
          <div>
              
              <Input type="phone"  name='phone'  label="Contact Number" onChange={formik.handleChange} value={formik.values.phone}></Input>
          </div>
          <br></br>
          <div>
            
              <Input type="password"  name='password'  label='Password' onChange={formik.handleChange} value={formik.values.password}></Input>
          </div>
          <br></br> <br></br>
